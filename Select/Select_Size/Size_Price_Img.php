<!-- 
    ĐÂY LÀ BODY CỦA TRANG CHI TIẾT SẢN PHẨM

    Dữ Liệu bao gồm IdProduct,Size,Ảnh,Giá được Đặt trong biến Size   
    
    ============Bảng Size Pro=============
    +> Nối 2 bảng size và pro để tránh mối quan hệ N-N
     PK  |  IdSizePro
     FK  |  IdSize
     FK  |  IdProduct
         |  Price
         |  ImgSizePro
    * UNIQUE(IdProduct,IdSize,Price) 
    =========== Bảng Size và Pro============
    +> Size có mỗi NameSize
    +> Pro gồm (category, name,mô tả,trạng thái,...)
    ...
    <div class="product_detail">
        ...
        <form action="OnlineController.php?act=LoadChiTietSanPham&id=<?= $_GET['id'] ?>" method="post" class="content">
            ...
            <div class="option">
                ...
                <div class="tanggiam">
                    <p>Size&nbsp;&nbsp;</p>
                    <!-- select size ra giá với ảnh tương ứng -->
